<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#066d3e"</h2> XUAN TRUONG SHOP
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2023 <a href="#" style="color:red">XUAN TRUONG SHOP</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
