...
class Giohang extends CI_Controller {
    ...
    public function index(){
        ...
        $this->data['title']='XuanTruongShop - Giỏ hàng của bạn';
    ...
    public function info_order(){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->data['title']='XuanTruongShop - Thông tin đơn hàng';
    ...
    public function thankyou(){
        if($this->session->userdata('info-customer')||$this->session->userdata('sessionKhachHang')){
            ...
            $this->email->to($list);
            $this->email->subject('XuanTruongShop');
        ...
        $this->data['title']='XuanTruongShop - Kết quả đơn hàng';
